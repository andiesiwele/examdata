...
heading = "Frequency Table showing Average Hours Spent Studying on campus by Math114 Students"
print(heading)
...
# Creating a DataFrame from the frequency table data
frequency_table_df = pd.DataFrame(data)
heading = "Frequency Table showing Average Hours Spent Studying on campus by CS114 Students"
print(heading)
print(frequency_table_df.to_string(index=False))
...
# Creating a DataFrame from the frequency table data
frequency_table_df = pd.DataFrame(data)
heading = "Frequency Table showing Number of Math114 Students in each Age Group "
print(heading)
print(frequency_table_df.to_string(index=False))
...
# Creating a DataFrame from the frequency table data
frequency_table_df = pd.DataFrame(data)
heading = "Frequency Table showing Number of CS114 Students in each Age Group "
print(heading)
print(frequency_table_df.to_string(index=False))
...
# Creating a DataFrame from the frequency table data
frequency_table_df = pd.DataFrame(data)
heading = "Frequency Table showing marks of Math114 Students "
print(heading)
print(frequency_table_df.to_string(index=False))
...
# Creating a DataFrame from the frequency table data
frequency_table_df = pd.DataFrame(data)
heading = "Frequency Table showing marks of CS114 Students "
print(heading)
print(frequency_table_df.to_string(index=False))
''''
...
# count number of students in each age group by creating counters for each age group
